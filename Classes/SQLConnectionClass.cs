...
namespace GelisimYonetimLoglamaMantigi.Classes
{
    public class SQLConnectionClass
    {
        private static string SQLConnectionString = @"Server = MUSTAFA\SQL2017; Database =URUN_AGACI_DB; Trusted_Connection = True;";
